...
SPACE =[skopt.space.Categorical(['arctan','log', None], name='app_cat'),]
...
def search(**params):
        ...
        # all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'], all_params['app'] , all_params['time'], all_params['time'], all_params['time'], all_params['time'], all_params['month'],
        # all_params['month'], all_params['month'], all_params['month'], all_params['month']]
        # print(len(transf_opts))
        ...
        print('Experiment with vars:  ',all_params['app_cat'])
        # print(mod_opt_xgb)
...
gp_results = skopt.gp_minimize(search, SPACE,n_calls=10)
